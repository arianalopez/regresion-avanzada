...
wdir<-""
wdir<-"/home/ariana/Documents/MCD/2016_3/regresion_avanzada/proyectofinal/regresion-avanzada/codigo/"
setwd(wdir)
...
write.csv(as_data_frame(cor(tabla_4anios_ok[,c(2,10,18:25)])),"../datos/corrs.csv")
...
########################################################################################################
###### ZIPoisson M1 1 var-beta y 1 var-gamma
...
#poisson y bin neg - exposure es el offset de POP_TOT
data<-list("n"=n,"y"=datos$homi_count,"exposure"=datos$POBTOT,"x1"=datos$POR_VPH_AUTOM,"z1"=datos$PROM_OCUP)
...
#-Running code-
#OpenBUGS
m1_ZIPoisson_log_logit_1_1.sim<-bugs(data,inits,parameters,model.file="ZIPoisson_1-1.txt",
                                 n.iter=1000,n.chains=1,n.burnin=100)

out_m1_ZIPoisson_log_logit_1_1.sim<-m1_ZIPoisson_log_logit_1_1.sim$sims.list
write.csv(out_m1_ZIPoisson_log_logit_1_1.sim,"m1_ZIPoisson_log_logit_1_1")
#############################################################################################
#Inicio del analisis Bayesiano

# Con 5000 iteraciones las cadenas no se mezclan bien :(
traceplot(m1_ZIPoisson_log_logit_1_1.sim)
plot(m1_ZIPoisson_log_logit_1_1.sim)


#Resumen (estimadores)
#OpenBUGS
out.sum_m1_ZIPoisson_log_logit_1_1.sim<-m1_ZIPoisson_log_logit_1_1.sim$summary
print(out.sum_m1_ZIPoisson_log_logit_1_1.sim)
################## Claramente los coeficientes Betas son significativos! Y el ser negativos habla de que hay menos homicidios en zonas donde hay mas proporción de viviendas con internet 
head(out.sum_m1_ZIPoisson_log_logit_1_1.sim,6)
