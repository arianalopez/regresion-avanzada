...
m1 <- zeroinfl(homi_count ~ POR_VPH_AUTOM + PROM_OCUP  | 1, dist="poisson", offset = log(POBTOT+1), data = datos)
summary(m1)

# Call:
#   zeroinfl(formula = homi_count ~ POR_VPH_AUTOM + PROM_OCUP | 1, data = datos, offset = log(POBTOT + 1), 
#            dist = "poisson")
# 
# Pearson residuals:
#   Min       1Q   Median       3Q      Max 
# -2.1132  -0.7732  -0.2995   0.5669 287.9085 
# 
# Count model coefficients (poisson with log link):
#   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)   -5.24964    0.10557  -49.73   <2e-16 ***
#   POR_VPH_AUTOM -2.49192    0.11961  -20.83   <2e-16 ***
#   PROM_OCUP     -0.40298    0.02603  -15.48   <2e-16 ***
#   
#   Zero-inflation model coefficients (binomial with logit link):
#   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)  -2.4211     0.1697  -14.27   <2e-16 ***
#   ---
#   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
# 
# Number of iterations in BFGS optimization: 17 
# Log-likelihood: -3967 on 4 Df


mnull <- update(m1, . ~ 1)
pchisq(2 * (logLik(m1) - logLik(mnull)), df = 3, lower.tail = FALSE)

#'log Lik.' 2.172846e-35 (df=5)

p1 <- glm(homi_count ~ POR_VPH_AUTOM + PROM_OCUP, family = poisson, data = datos)
summary(p1)
